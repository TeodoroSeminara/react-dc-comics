const MyShop = () => {
    return (
        <div className="container-shop">
            <ul className="shop-list container">
                ...
                <li><a href="#"><img src="../src/assets/img/buy-comics-shop-locator.png" alt="" />COMIC SHOP LOCATOR</a></li>
                <li><a href="#"><img src="../src/assets/img/buy-dc-power-visa.svg" alt="" />DC POWER VISA</a></li>
            </ul>
        </div>
    )
}
